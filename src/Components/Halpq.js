...
class Halpq extends Component {
  ...
  componentDidMount() {
    dbRef.ref(`/Classrooms/${this.state.classKey}`).on('value', snapshot => {
      this.setState({
    ...
    return (
      <div className="halpq">
        <div className="wrapper clearfix">
          <h2 className="halpq__title">{classroomName}</h2>
                  ...
                  >
                    ...
                    <g display="none">
                      <path
                        fill="black"
                        display="inline"
                        d="M70,75H30C16.215,75,5,63.785,5,50s11.215-25,25-25h40c13.785,0,25,11.215,25,25S83.785,75,70,75z M30,29   C18.421,29,9,38.421,9,50s9.421,21,21,21h40c11.579,0,21-9.421,21-21s-9.421-21-21-21H30z M30,69c-10.477,0-19-8.523-19-19   s8.523-19,19-19s19,8.523,19,19S40.477,69,30,69z M30,35c-8.271,0-15,6.729-15,15s6.729,15,15,15s15-6.729,15-15S38.271,35,30,35z"
                      />
                    </g>
                  </svg>
                ) : (
                  <svg
                    className="halpq__toggleclassroom__active"
                    xmlns="http://www.w3.org/2000/svg"
                    xlink="http://www.w3.org/1999/xlink"
                    version="1.1"
                    x="0px"
                  ...
                  >
                    ...
                    <g display="none">
                      <path
                        fill="black"
                        display="inline"
                        d="M70,25H30C16.215,25,5,36.215,5,50s11.215,25,25,25h40c13.785,0,25-11.215,25-25S83.785,25,70,25z M70,71   H30C18.421,71,9,61.579,9,50s9.421-21,21-21h40c11.579,0,21,9.421,21,21S81.579,71,70,71z M70,31c-10.477,0-19,8.523-19,19   s8.523,19,19,19s19-8.523,19-19S80.477,31,70,31z M70,65c-8.271,0-15-6.729-15-15s6.729-15,15-15s15,6.729,15,15S78.271,65,70,65z"
                      />
                    </g>
                  </svg>
                )}
