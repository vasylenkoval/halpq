  ...
  render() {
    return <div className="questionConversation clearfix">
        {this.state.isAdmin ? this.state.chatStarted ? <button type="button" onClick={this.handleChange} className="">
              ...
              <div className="buttonImage">
                <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="16 12 70 74" fill="black" space="preserve">
                  <g>
